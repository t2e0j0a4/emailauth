    ...
    <div className="w-[100%] mx-auto h-[100%] flex items-center justify-center gap-y-4 bg-gray-100">
      ...
      <div className=" w-[300px] sm:w-[500px] px-6 py-4 my-6 flex flex-col items-center justify-center gap-y-3 bg-gray-50 shadow-sm rounded-[6px] ">
        ...
        <form className=" w-[100%] flex flex-col items-center justify-center gap-y-[12px]" onSubmit={formik.handleSubmit}>
          ...
          <div className="w-[100%] flex flex-row gap-x-3">
            <div className="w-[100%] flex flex-col items-start justify-center gap-y-[0.2px]">
              ...
              <input type="text" className="font-light text-[18px] px-3 py-1 w-[100%] outline-none border-2 border-[#232323] rounded-[4px]" id="fname" name="fname" placeholder="John" value={formik.values.fname} onChange={formik.handleChange}/>
            </div>
            <div className="w-[100%] flex flex-col items-start justify-center gap-y-[0.2px]">
              <label htmlFor="username" className="w-[100%] text-[16px] tracking-wide text-[#232323] font-light">
                Last Name
              </label>
              <input type="text" className="font-light text-[18px] px-3 py-1 w-[100%] outline-none border-2 border-[#232323] rounded-[4px]" id="lname" name="lname" placeholder="Doe" value={formik.values.lname} onChange={formik.handleChange}/>
            </div>
          </div>
        ...
        <div className="w-[100%] flex flex-row items-center justify-center my-2">
          <button type="button" className="w-full text-[#232323] py-2 shadow-lg bg-white rounded-[6px] hover:shadow-none hover:scale-95 transition-all duration-500">Logout</button>
        </div>
      </div>
    </div>
  );
